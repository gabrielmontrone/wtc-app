        ...
        when {
            ...
            state.campaigns.isEmpty() ->
                Column(
                    ...
                    horizontalAlignment = Alignment.CenterHorizontally,
                    verticalArrangement = Arrangement.Center,
                ) { Text("Nenhuma campanha ainda", color = Color(0xFF555555)) }
            else ->
                LazyColumn(
                    modifier = Modifier.weight(1f),
...
fun CampanhaCard(campaign: Campaign) {
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Text(campaign.name, fontSize = 16.sp, fontWeight = FontWeight.Bold, color = Color(0xFF1976D2))
            Text("Status: ${campaign.status}", fontSize = 14.sp, color = Color(0xFF555555))
            Text(
